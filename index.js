...
// Function that converts seconds to minute and second format used in song play
...
async function getSongs(folder) {
    ...
    //show all the songs in thie playlist
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            ...
            <div class="play">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                    ...
                    <path d="M5 20V4L19 12L5 20Z" fill="#141B34" stroke-linejoin="round" />
                </svg>
...
async function main() {
    ...
    //Add event listenerto the hamburger
    document.querySelector(".hamburger").addEventListener("click", () => {
        document.querySelector(".left").style.left = 0;
    });

    //Add a event listener in close button
